            ...
            <main id="imageSlider" style={{ '--sliderWidth': sliderWidth + 'px', }}>
                ...
                <section>
                    <div style={{ transform: `translateX(${dealIndex * - sliderWidth}px)`, }}>
                        <Images color1='#212844' color2='#2c3454' img={`${apiUrl}/img/smartWatch.png`} />
                        <Images color1='#ff1212' color2='#ff6868' img={`${apiUrl}/img/smartWatch3.png`} />
                        <Images color1='#797979' color2='#9f9f9f' img={`${apiUrl}/img/smartWatch2.png`} />
                        <Images color1='#000' color2='#3b3b3b' img={`${apiUrl}/img/smartWatch4.png`} />
                        <Images color1='#71706e' color2='#beb4a0' img={`${apiUrl}/img/smartWatch5.png`} />
                    </div>
                </section>
                <div id='circles'>
                    <span></span>
